...
{ 
    public class CustomerController : HomeController
    {
        ...
        public IActionResult CustomerDashboard()
        {
            ...
            var x = helperlandContext.ServiceRequests.Where(m => m.UserId == a).ToList();
            CustomerDashboardViewModel requestList = new CustomerDashboardViewModel();
        ...
        {
            var a = int.Parse(HttpContext.Session.GetString("UserID"));
            CustomerDashboardViewModel settings = new CustomerDashboardViewModel();
            settings.user = helperlandContext.Users.Find(a);
            ...
            settings.Address = helperlandContext.UserAddresses.Where(m => m.UserId == a).ToList(); 
        ...
        [HttpPost]
        public IActionResult ServiceCancel(CancelServiceViewModel model)
        {
        ...
        public IActionResult Ratting(Rating model)
        {
            ...
            model.RatingTo = a.ServiceProviderId;
